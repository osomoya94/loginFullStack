...
__decorate([
    (0, typeorm_1.Column)({ type: "varchar", length: 10, nullable: false, default: IAppointmentInterfaces_1.Status.active }),
    __metadata("design:type", String)
], Appointment.prototype, "status", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => User_entities_1.User, user => user.appointments, { nullable: false }),
